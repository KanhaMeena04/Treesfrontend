    ...
    <div className="max-w-4xl mx-auto p-3 sm:p-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 mb-6 h-auto">
          <TabsTrigger value="account" className="flex items-center space-x-2 text-xs sm:text-sm">
            <User className="w-4 h-4" />
            <span>Account</span>
          </TabsTrigger>
          <TabsTrigger value="privacy" className="flex items-center space-x-2 text-xs sm:text-sm">
            <Shield className="w-4 h-4" />
            <span>Privacy</span>
          </TabsTrigger>
          <TabsTrigger value="notifications" className="flex items-center space-x-2 text-xs sm:text-sm">
            <Bell className="w-4 h-4" />
            <span>Notifications</span>
          </TabsTrigger>
          <TabsTrigger value="app" className="flex items-center space-x-2 text-xs sm:text-sm">
