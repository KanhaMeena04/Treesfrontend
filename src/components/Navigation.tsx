...
import { Home, Search, Play, Radio, Heart, MessageCircle, User, Settings, Bell, Crown, Gift } from 'lucide-react';
...
export const Navigation = ({ activeTab, onTabChange, className }: NavigationProps) => {
  ...
  return (
    <nav className={cn('bg-white border-r border-accent/20 shadow-sm', className)}>
      <div className="p-4">
        <div className="flex items-center space-x-3 mb-8">
          ...
          <h1 className="text-2xl font-bold text-primary font-treesh">Treesh</h1>
        </div>
        ...
        {navItems.map((item) => {
          ...
          return (
            <Button
              ...
              size="sm"
              className={cn(
                'flex flex-col items-center space-y-1 h-12 px-2 font-inter',
